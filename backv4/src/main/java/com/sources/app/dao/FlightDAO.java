...
public class FlightDAO {
    ...
    public boolean cancelFlight(Integer flightId, String cancellationReason, Integer cancelledBy) {
        System.out.println("\n=================================================");
        System.out.println("🚀 FlightDAO.cancelFlight() - INICIANDO CANCELACIÓN [AEROLINEA2]");
        System.out.println("=================================================");
        ...
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            ...
            System.out.println("\n🚀🚀🚀 === BACKV4: INICIANDO ENVÍO DE NOTIFICACIONES === 🚀🚀🚀");
            System.out.println("DEBUG: Vuelo cancelado exitosamente en BD, ahora enviando correos...");
            try {
                System.out.println("DEBUG: Creando instancia de RealEmailService...");
                com.sources.app.services.RealEmailService emailService = new com.sources.app.services.RealEmailService();
                System.out.println("DEBUG: ✅ RealEmailService creado exitosamente");
                
                // Enviar a pasajeros
                System.out.println("DEBUG: Llamando a sendFlightCancellationNotifications...");
                ...
                // Enviar a agencias
                System.out.println("DEBUG: Llamando a sendCancellationNotificationsToAgencies...");
                boolean agencyEmailsSent = emailService.sendCancellationNotificationsToAgencies(flightId, cancellationReason);
                
                if (agencyEmailsSent) {
                    System.out.println("✅ BACKV4: Notificaciones enviadas exitosamente a agencias");
                } else {
                    System.out.println("⚠️ BACKV4: Algunas notificaciones a agencias no se pudieron enviar");
                }
                
                System.out.println("🚀 === FIN DE ENVÍO DE NOTIFICACIONES ===\n");
                
            } catch (Throwable emailException) {
                System.err.println("❌❌❌ BACKV4: Error CRÍTICO enviando notificaciones ❌❌❌");
                System.err.println("Tipo de excepción: " + emailException.getClass().getName());
                System.err.println("Mensaje: " + emailException.getMessage());
