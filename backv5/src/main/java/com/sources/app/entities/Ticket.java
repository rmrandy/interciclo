...
public class Ticket {
    ...
    /**
     * Usuario empresarial que compró el ticket.
     * Si es null, significa que el comprador es el mismo que el pasajero (user).
     * Si no es null, indica que fue una compra empresarial (ej: agencia comprando para un cliente).
     */
    @ManyToOne
    @JoinColumn(name = "PURCHASED_BY_USER_ID", referencedColumnName = "ID_USER")
    ...
    /**
     * Obtiene el usuario empresarial que compró el ticket.
     * @return el usuario que compró o null si fue compra individual.
     */
    public User getPurchasedByUser() { return purchasedByUser; }
    /**
     * Establece el usuario empresarial que compró el ticket.
     * @param purchasedByUser el usuario empresarial comprador.
     */
    public void setPurchasedByUser(User purchasedByUser) { this.purchasedByUser = purchasedByUser; }

    /**
     * Verifica si este ticket fue comprado por un usuario empresarial.
     * @return true si fue compra empresarial, false si fue compra individual.
     */
    public boolean isCorporatePurchase() {
        return purchasedByUser != null && purchasedByUser.isCorporateUser();
    }
