...
public class User {
    ...
    /**
     * Indica si el usuario es empresarial (agencia, corporativo).
     * 1 = Usuario empresarial, 0 = Usuario individual.
     * Los usuarios empresariales pueden comprar en nombre de otros.
     */
    @Column(name = "IS_CORPORATE", precision = 1, scale = 0)
    private Integer isCorporate;  // 1 = empresarial, 0 = individual

    /**
     * Nombre de la empresa o agencia (solo para usuarios empresariales).
     * Puede ser nulo para usuarios individuales.
     */
    @Column(name = "COMPANY_NAME", length = 200)
    private String companyName;  // Nombre de la empresa

    /**
     * API Key única para autenticación de usuarios empresariales.
     * Permite autenticación sin necesidad de login tradicional.
     * Debe ser única en el sistema.
     */
    @Column(name = "API_KEY", length = 100, unique = true)
    private String apiKey;  // Token de autenticación empresarial
    ...
    public User() {
        ...
        this.isCorporate = 0; // Por defecto, usuario individual
    }
    ...
    /**
     * Obtiene si el usuario es empresarial.
     * @return 1 si es empresarial, 0 si es individual, null si no definido.
     */
    public Integer getIsCorporate() { return isCorporate; }
    /**
     * Establece si el usuario es empresarial.
     * @param isCorporate 1 para empresarial, 0 para individual.
     */
    public void setIsCorporate(Integer isCorporate) { this.isCorporate = isCorporate; }

    /**
     * Obtiene el nombre de la empresa.
     * @return el nombre de la empresa o null si es usuario individual.
     */
    ...
    /**
     * Obtiene el API Key del usuario empresarial.
     * @return el API Key o null si no es empresarial.
     */
    public String getApiKey() { return apiKey; }
    /**
     * Establece el API Key del usuario empresarial.
     * @param apiKey el API Key único para autenticación.
     */
    public void setApiKey(String apiKey) { this.apiKey = apiKey; }

    /**
     * Verifica si el usuario es empresarial.
     * @return true si es empresarial, false si no lo es.
     */
    public boolean isCorporateUser() {
        return isCorporate != null && isCorporate == 1;
    }
