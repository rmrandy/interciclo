...
public class RealEmailService {
    ...
    private boolean sendEmail(String to, String subject, String htmlContent) {
        try {
            ...
            message.setFrom(new InternetAddress(fromEmail, "AEROLINEA3 - Sistema de Notificaciones"));
            ...
            <body>
                <div class="container">
                    <div class="header">
                        ...
                        <p style="margin: 5px 0 0 0; font-size: 14px;">AEROLINEA3</p>
                    </div>
                    <div class="content">
                        ...
                        <p style="margin-top: 15px;">
                            Atentamente,<br>
                            <strong>AEROLINEA3</strong><br>
                            Sistema de Gestión de Vuelos
                        </p>
                        
                        <div class="footer">
                            <p>Este es un correo automático, por favor no responda.</p>
                            <p style="margin: 5px 0;">&copy; 2024 AEROLINEA3. Todos los derechos reservados.</p>
                        </div>
                    </div>
                </div>
            </body>
