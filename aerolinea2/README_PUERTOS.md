...
- **Puerto**: 2020 (por defecto)
- **API**: http://localhost:2020/api

El frontend (puerto 5050) se comunicará con el backend (puerto 2020).
...
3. **Puerto 8081**: Buena alternativa si 2020 está ocupado
