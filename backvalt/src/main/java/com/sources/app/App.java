...
import com.sources.app.controllers.SiteContentController;
...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        server.createContext("/api2/site-content", new SiteContentHandler());
        server.createContext("/api2/site-content-v2", new SiteContentController());
        ...
        // Inicializar contenido del sitio (tabla y registros iniciales)
        try {
            SiteContentDAO siteContentDAO = new SiteContentDAO();
            siteContentDAO.initializeDefaultContent();
            System.out.println("Tabla site_content verificada/inicializada correctamente.");
        } catch (Exception e) {
            System.err.println("Error al inicializar la tabla site_content:");
            e.printStackTrace();
        }
