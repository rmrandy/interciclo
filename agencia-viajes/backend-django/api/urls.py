...
from .views import login_view, register_view, profile_view, airlines_list_view, airlines_detail_view, airlines_active_view, proxy_airline_cities, proxy_airline_flights, proxy_airline_seats, proxy_airline_create_ticket, proxy_airline_create_roundtrip, proxy_airline_create_stopover, proxy_airline_login, proxy_airline_register, proxy_airline_tickets, proxy_airline_ticket_pdf, proxy_airline_ticket_by_id, proxy_airline_flight_reviews, proxy_airline_corporate_tickets, agency_reviews_view, db_info_view, users_list_view, users_detail_view
