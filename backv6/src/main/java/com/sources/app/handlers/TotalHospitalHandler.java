...
public class TotalHospitalHandler implements HttpHandler {

    private final TotalHospitalDAO totalHospitalDAO;
    private final ObjectMapper objectMapper;
    private static final String ENDPOINT = "/api/totalhospital";

    public TotalHospitalHandler(TotalHospitalDAO totalHospitalDAO) {
        this.totalHospitalDAO = totalHospitalDAO;
