...
public class TicketHandler implements HttpHandler {
    ...
    private String handleCreateRoundTripTickets(HttpExchange exchange) throws IOException {
        ...
        try {
            ...
            if (ticket1 != null && ticket2 != null) {
                // Calcular precio total de ida y vuelta
                BigDecimal totalFare = ticket1.getFare().add(ticket2.getFare());
                BigDecimal totalAmount = ticket1.getTotalAmount().add(ticket2.getTotalAmount());
                ...
                t1Map.put("originCity", ticket1.getFlight().getOriginCity() != null ? ticket1.getFlight().getOriginCity().getName() : "");
                t1Map.put("destinationCity", ticket1.getFlight().getDestinationCity() != null ? ticket1.getFlight().getDestinationCity().getName() : "");
                t1Map.put("fare", ticket1.getFare());
                t1Map.put("totalAmount", ticket1.getTotalAmount());
                tickets.add(t1Map);
                ...
                t2Map.put("originCity", ticket2.getFlight().getOriginCity() != null ? ticket2.getFlight().getOriginCity().getName() : "");
                t2Map.put("destinationCity", ticket2.getFlight().getDestinationCity() != null ? ticket2.getFlight().getDestinationCity().getName() : "");
                t2Map.put("fare", ticket2.getFare());
                t2Map.put("totalAmount", ticket2.getTotalAmount());
                tickets.add(t2Map);
                
                System.out.println("✅ Round-trip: Tickets #" + ticket1.getIdTicket() + " y #" + ticket2.getIdTicket());
                System.out.println("💰 Precio total: $" + totalAmount + " (IDA: $" + ticket1.getTotalAmount() + " + VUELTA: $" + ticket2.getTotalAmount() + ")");
                ...
                return gson.toJson(Map.of(
                    ...
                    "breakdown", Map.of(
                        "outboundPrice", ticket1.getTotalAmount(),
                        "returnPrice", ticket2.getTotalAmount(),
    ...
    private String handleCreateStopoverTickets(HttpExchange exchange) throws IOException {
        ...
        try {
            ...
            if (ticket1 != null && ticket2 != null) {
                // Calcular precio total de ambos segmentos
                BigDecimal totalFare = ticket1.getFare().add(ticket2.getFare());
                BigDecimal totalAmount = ticket1.getTotalAmount().add(ticket2.getTotalAmount());
                ...
                System.out.println("💰 Precio total: $" + totalAmount + " (Segmento 1: $" + ticket1.getTotalAmount() + " + Segmento 2: $" + ticket2.getTotalAmount() + ")");
                ...
                return gson.toJson(Map.of(
                    ...
                    "totalAmount", totalAmount,
                    "breakdown", Map.of(
                        "segment1Price", ticket1.getTotalAmount(),
                        "segment2Price", ticket2.getTotalAmount(),
                        "totalPrice", totalAmount
                    )
                ));
            } else {
