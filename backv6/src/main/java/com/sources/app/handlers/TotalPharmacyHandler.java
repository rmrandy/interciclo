...
public class TotalPharmacyHandler implements HttpHandler {

    private final TotalPharmacyDAO totalPharmacyDAO;
    private final ObjectMapper objectMapper;
    private static final String ENDPOINT = "/api/totalpharmacy";

    public TotalPharmacyHandler(TotalPharmacyDAO totalPharmacyDAO) {
        this.totalPharmacyDAO = totalPharmacyDAO;
    ...
    private void handleGet(HttpExchange exchange) throws IOException {
        ...
        if(query != null && query.contains("id=")){
            ...
            try{
                ...
                TotalPharmacy tp = totalPharmacyDAO.findById(id);
                if(tp != null){
            ...
            List<TotalPharmacy> list = totalPharmacyDAO.findAll();
    ...
    private void handlePut(HttpExchange exchange) throws IOException {
        String requestBody = new String(exchange.getRequestBody().readAllBytes(), StandardCharsets.UTF_8);
        TotalPharmacy tp = objectMapper.readValue(requestBody, TotalPharmacy.class);
        TotalPharmacy updated = totalPharmacyDAO.update(tp);
        if(updated != null){
