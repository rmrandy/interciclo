...
public class RealEmailService {
    ...
    private boolean sendEmail(String to, String subject, String htmlContent) {
        try {
            ...
            message.setFrom(new InternetAddress(fromEmail, "AEROLINEA4 - Sistema de Notificaciones"));
    ...
    private boolean sendWebhookToAgency(Flight flight, String cancellationReason) {
        try {
            ...
            String jsonPayload = String.format("""
                {
                    "flightId": %d,
                    "flightNumber": "%s",
                    "airlineCode": "AEROLINEA4",
                    "airlineName": "Aerolínea Nacional 4",
                    "originCity": "%s",
                    "destinationCity": "%s",
                    "departureDate": "%s",
                    "departureTime": "%s",
            ...
            System.err.println("   URL: " + System.getenv("AGENCIA_WEBHOOK_URL"));
            return false;
        } catch (Exception e) {
            ...
            <body>
                <div class="container">
                    <div class="header">
                        ...
                        <p style="margin: 5px 0 0 0; font-size: 14px;">AEROLINEA4</p>
                    </div>
                    <div class="content">
                        ...
                        <p style="margin-top: 15px;">
                            Atentamente,<br>
                            <strong>AEROLINEA4</strong><br>
                            Sistema de Gestión de Vuelos
                        </p>
                        
                        <div class="footer">
                            <p>Este es un correo automático, por favor no responda.</p>
                            <p style="margin: 5px 0;">&copy; 2024 AEROLINEA4. Todos los derechos reservados.</p>
                        </div>
                    </div>
                </div>
            </body>
