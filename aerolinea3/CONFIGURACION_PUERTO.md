...
# Terminal 1 - Backend
cd backv4
./run_app_server.sh    # Puerto 6060

# Terminal 2 - Frontend
cd aerolinea
./start.sh             # Puerto 5050
```
- Backend: `http://localhost:6060/api`
...
| 6060 | Backend Java | ❌ Ocupado por backv4 |
