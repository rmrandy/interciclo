...
let portConfig: PortConfig = {
  ensurance: "6060",  // Puerto por defecto para ensurance
  pharmacy: "6060",   // Puerto por defecto para pharmacy
  airline: "6060"     // Puerto por defecto para aerolínea (mismo servidor)
};
